...
class HiddenLayer(val W: INDArray, val h: INDArray, val activation: ActivationFunction, val loss: LossFunction)(implicit rng:MersenneTwister) extends Serializable {
